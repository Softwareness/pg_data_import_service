...
#   function_name = "pg-data-import-service"
#   role          = aws_iam_role.lambda_role.arn

#   handler = "index.handler" # update dit afhankelijk van je runtime en handler
#   runtime = "go1.x"     # update dit afhankelijk van je runtime

#   filename         = "import/lambda-import.zip"
#   source_code_hash = filebase64sha256("import/lambda-import.zip")
# }
# resource "aws_lambda_permission" "allow_bucket_data_import" {
#   statement_id  = "AllowExecutionFromS3Bucket"
#   action        = "lambda:InvokeFunction"
#   function_name = aws_lambda_function.data-import.function_name
...
resource "aws_lambda_function" "payload" {
  ...
  filename         = "payload/main.zip"
  source_code_hash = filebase64sha256("payload/main.zip")
  environment {
    variables = {
